...
// ../graphs/node_modules/d3/src/index.js
var src_exports = {};
...
// ../graphs/node_modules/d3-array/src/number.js
function number(x4) {
...
// ../graphs/node_modules/d3-array/src/bisect.js
...
// ../graphs/node_modules/d3-array/src/blur.js
...
function Blur2(blur3) {
  return function(data2, rx, ry = rx) {
    ...
    let { data: values, width, height } = data2;
...
// ../graphs/node_modules/d3-array/src/count.js
...
// ../graphs/node_modules/d3-array/src/cross.js
...
// ../graphs/node_modules/d3-array/src/deviation.js
function deviation(values, valueof) {
  const v2 = variance(values, valueof);
  return v2 ? Math.sqrt(v2) : v2;
}

// ../graphs/node_modules/d3-array/src/extent.js
...
// ../graphs/node_modules/d3-array/src/fsum.js
var Adder = class {
  constructor() {
...
// ../graphs/node_modules/internmap/src/index.js
...
// ../graphs/node_modules/d3-array/src/identity.js
function identity(x4) {
  return x4;
}

// ../graphs/node_modules/d3-array/src/group.js
...
function nest(values, map4, reduce2, keys) {
  return function regroup(values2, i) {
    ...
    for (const value of values2) {
      ...
      const group2 = groups3.get(key);
      if (group2)
        group2.push(value);
      else
        groups3.set(key, [value]);
    }
    for (const [key, values3] of groups3) {
      groups3.set(key, regroup(values3, i));
    }
    return map4(groups3);
  }(values, 0);
}

// ../graphs/node_modules/d3-array/src/permute.js
function permute(source, keys) {
  return Array.from(keys, (key) => source[key]);
}

// ../graphs/node_modules/d3-array/src/sort.js
...
// ../graphs/node_modules/d3-array/src/groupSort.js
...
// ../graphs/node_modules/d3-array/src/array.js
var array = Array.prototype;
var slice = array.slice;
var map = array.map;

// ../graphs/node_modules/d3-array/src/constant.js
function constant(x4) {
  return () => x4;
}

// ../graphs/node_modules/d3-array/src/ticks.js
...
// ../graphs/node_modules/d3-array/src/nice.js
...
// ../graphs/node_modules/d3-array/src/threshold/sturges.js
function thresholdSturges(values) {
  return Math.max(1, Math.ceil(Math.log(count(values)) / Math.LN2) + 1);
}

// ../graphs/node_modules/d3-array/src/bin.js
function bin() {
  var value = identity, domain = extent, threshold2 = thresholdSturges;
  function histogram(data2) {
    if (!Array.isArray(data2))
      data2 = Array.from(data2);
    var i, n = data2.length, x4, step, values = new Array(n);
    for (i = 0; i < n; ++i) {
    ...
    if (isFinite(step)) {
      if (step > 0) {
        for (i = 0; i < n; ++i) {
          if ((x4 = values[i]) != null && x06 <= x4 && x4 <= x12) {
            bins[Math.min(m3, Math.floor((x4 - x06) / step))].push(data2[i]);
          }
        }
      } else if (step < 0) {
        for (i = 0; i < n; ++i) {
          if ((x4 = values[i]) != null && x06 <= x4 && x4 <= x12) {
            ...
            bins[Math.min(m3, j + (tz[j] <= x4))].push(data2[i]);
          }
        }
      }
    } else {
      for (i = 0; i < n; ++i) {
        if ((x4 = values[i]) != null && x06 <= x4 && x4 <= x12) {
          bins[bisect_default(tz, x4, 0, m3)].push(data2[i]);
        }
      }
    }
    return bins;
...
// ../graphs/node_modules/d3-array/src/max.js
...
// ../graphs/node_modules/d3-array/src/maxIndex.js
...
// ../graphs/node_modules/d3-array/src/min.js
...
// ../graphs/node_modules/d3-array/src/minIndex.js
...
// ../graphs/node_modules/d3-array/src/quickselect.js
...
// ../graphs/node_modules/d3-array/src/greatest.js
...
// ../graphs/node_modules/d3-array/src/quantile.js
...
// ../graphs/node_modules/d3-array/src/threshold/freedmanDiaconis.js
...
// ../graphs/node_modules/d3-array/src/threshold/scott.js
...
// ../graphs/node_modules/d3-array/src/mean.js
...
// ../graphs/node_modules/d3-array/src/median.js
...
// ../graphs/node_modules/d3-array/src/merge.js
...
// ../graphs/node_modules/d3-array/src/mode.js
...
// ../graphs/node_modules/d3-array/src/pairs.js
...
// ../graphs/node_modules/d3-array/src/range.js
...
// ../graphs/node_modules/d3-array/src/rank.js
...
// ../graphs/node_modules/d3-array/src/least.js
...
// ../graphs/node_modules/d3-array/src/leastIndex.js
...
// ../graphs/node_modules/d3-array/src/greatestIndex.js
...
// ../graphs/node_modules/d3-array/src/scan.js
function scan(values, compare) {
  const index3 = leastIndex(values, compare);
  return index3 < 0 ? void 0 : index3;
}

// ../graphs/node_modules/d3-array/src/shuffle.js
...
// ../graphs/node_modules/d3-array/src/sum.js
...
// ../graphs/node_modules/d3-array/src/transpose.js
...
// ../graphs/node_modules/d3-array/src/zip.js
function zip() {
  return transpose(arguments);
}

// ../graphs/node_modules/d3-array/src/every.js
...
// ../graphs/node_modules/d3-array/src/some.js
...
// ../graphs/node_modules/d3-array/src/filter.js
...
// ../graphs/node_modules/d3-array/src/map.js
...
// ../graphs/node_modules/d3-array/src/reduce.js
...
// ../graphs/node_modules/d3-array/src/reverse.js
...
// ../graphs/node_modules/d3-array/src/difference.js
...
// ../graphs/node_modules/d3-array/src/disjoint.js
...
// ../graphs/node_modules/d3-array/src/intersection.js
...
// ../graphs/node_modules/d3-array/src/superset.js
...
// ../graphs/node_modules/d3-array/src/subset.js
function subset(values, other) {
  return superset(other, values);
}

// ../graphs/node_modules/d3-array/src/union.js
...
// ../graphs/node_modules/d3-axis/src/identity.js
function identity_default(x4) {
  return x4;
}

// ../graphs/node_modules/d3-axis/src/axis.js
var top = 1;
var right = 2;
var bottom = 3;
var left = 4;
...
function select_default(select) {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, subgroups = new Array(m3), j = 0; j < m3; ++j) {
    for (var group2 = groups3[j], n = group2.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) {
...
function selectAll_default(select) {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, subgroups = [], parents = [], j = 0; j < m3; ++j) {
    for (var group2 = groups3[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
...
function filter_default(match) {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, subgroups = new Array(m3), j = 0; j < m3; ++j) {
    for (var group2 = groups3[j], n = group2.length, subgroup = subgroups[j] = [], node, i = 0; i < n; ++i) {
...
function data_default(value, key) {
  ...
  for (var m3 = groups3.length, update = new Array(m3), enter = new Array(m3), exit = new Array(m3), j = 0; j < m3; ++j) {
    var parent = parents[j], group2 = groups3[j], groupLength = group2.length, data2 = arraylike(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data2.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength), exitGroup = exit[j] = new Array(groupLength);
...
function order_default() {
  for (var groups3 = this._groups, j = -1, m3 = groups3.length; ++j < m3; ) {
    for (var group2 = groups3[j], i = group2.length - 1, next = group2[i], node; --i >= 0; ) {
      if (node = group2[i]) {
...
function sort_default(compare) {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, sortgroups = new Array(m3), j = 0; j < m3; ++j) {
    for (var group2 = groups3[j], n = group2.length, sortgroup = sortgroups[j] = new Array(n), node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
        sortgroup[i] = node;
      }
    }
...
function node_default() {
  for (var groups3 = this._groups, j = 0, m3 = groups3.length; j < m3; ++j) {
    for (var group2 = groups3[j], i = 0, n = group2.length; i < n; ++i) {
      var node = group2[i];
      if (node)
        return node;
    }
...
function each_default(callback) {
  for (var groups3 = this._groups, j = 0, m3 = groups3.length; j < m3; ++j) {
    for (var group2 = groups3[j], i = 0, n = group2.length, node; i < n; ++i) {
      if (node = group2[i])
...
// ../graphs/node_modules/d3-selection/src/select.js
function select_default2(selector) {
  return typeof selector === "string" ? new Selection([[document.querySelector(selector)]], [document.documentElement]) : new Selection([[selector]], root);
}

// ../graphs/node_modules/d3-selection/src/create.js
function create_default(name) {
  return select_default2(creator_default(name).call(document.documentElement));
}

// ../graphs/node_modules/d3-selection/src/local.js
var nextId = 0;
function local() {
  return new Local();
}
...
// ../graphs/node_modules/d3-selection/src/sourceEvent.js
...
// ../graphs/node_modules/d3-selection/src/pointer.js
...
// ../graphs/node_modules/d3-selection/src/pointers.js
...
// ../graphs/node_modules/d3-selection/src/selectAll.js
...
// ../graphs/node_modules/d3-drag/src/noevent.js
...
// ../graphs/node_modules/d3-drag/src/nodrag.js
...
// ../graphs/node_modules/d3-drag/src/constant.js
var constant_default2 = (x4) => () => x4;

// ../graphs/node_modules/d3-drag/src/event.js
...
// ../graphs/node_modules/d3-drag/src/drag.js
...
// ../graphs/node_modules/d3-color/src/math.js
var radians = Math.PI / 180;
var degrees = 180 / Math.PI;

// ../graphs/node_modules/d3-color/src/lab.js
var K = 18;
var Xn = 0.96422;
var Yn = 1;
var Zn = 0.82521;
...
// ../graphs/node_modules/d3-color/src/cubehelix.js
var A = -0.14861;
var B = 1.78277;
var C = -0.29227;
var D = -0.90649;
...
// ../graphs/node_modules/d3-interpolate/src/numberArray.js
...
// ../graphs/node_modules/d3-interpolate/src/array.js
...
// ../graphs/node_modules/d3-interpolate/src/date.js
...
// ../graphs/node_modules/d3-interpolate/src/object.js
...
// ../graphs/node_modules/d3-interpolate/src/value.js
...
// ../graphs/node_modules/d3-interpolate/src/discrete.js
...
// ../graphs/node_modules/d3-interpolate/src/hue.js
...
// ../graphs/node_modules/d3-interpolate/src/round.js
...
// ../graphs/node_modules/d3-interpolate/src/zoom.js
var epsilon2 = 1e-12;
function cosh(x4) {
...
// ../graphs/node_modules/d3-interpolate/src/hsl.js
function hsl2(hue2) {
...
// ../graphs/node_modules/d3-interpolate/src/lab.js
...
// ../graphs/node_modules/d3-interpolate/src/hcl.js
function hcl2(hue2) {
  return function(start2, end) {
...
// ../graphs/node_modules/d3-interpolate/src/cubehelix.js
...
// ../graphs/node_modules/d3-interpolate/src/piecewise.js
...
// ../graphs/node_modules/d3-interpolate/src/quantize.js
...
// ../graphs/node_modules/d3-timer/src/interval.js
...
function transition_default() {
  ...
  for (var groups3 = this._groups, m3 = groups3.length, j = 0; j < m3; ++j) {
    for (var group2 = groups3[j], n = group2.length, node, i = 0; i < n; ++i) {
      if (node = group2[i]) {
...
// ../graphs/node_modules/d3-ease/src/linear.js
var linear2 = (t) => +t;

// ../graphs/node_modules/d3-ease/src/quad.js
function quadIn(t) {
  return t * t;
}
function quadOut(t) {
...
// ../graphs/node_modules/d3-ease/src/poly.js
var exponent = 3;
...
// ../graphs/node_modules/d3-ease/src/sin.js
var pi = Math.PI;
var halfPi = pi / 2;
function sinIn(t) {
...
// ../graphs/node_modules/d3-ease/src/math.js
function tpmt(x4) {
  return (Math.pow(2, -10 * x4) - 9765625e-10) * 1.0009775171065494;
}

// ../graphs/node_modules/d3-ease/src/exp.js
function expIn(t) {
  return tpmt(1 - +t);
}
function expOut(t) {
...
// ../graphs/node_modules/d3-ease/src/circle.js
function circleIn(t) {
...
// ../graphs/node_modules/d3-ease/src/bounce.js
var b1 = 4 / 11;
var b2 = 6 / 11;
var b3 = 8 / 11;
var b4 = 3 / 4;
...
// ../graphs/node_modules/d3-ease/src/back.js
...
// ../graphs/node_modules/d3-ease/src/elastic.js
var tau = 2 * Math.PI;
var amplitude = 1;
var period = 0.3;
...
// ../graphs/node_modules/d3-transition/src/active.js
var root2 = [null];
...
// ../graphs/node_modules/d3-brush/src/constant.js
var constant_default4 = (x4) => () => x4;

// ../graphs/node_modules/d3-brush/src/event.js
...
// ../graphs/node_modules/d3-brush/src/noevent.js
...
// ../graphs/node_modules/d3-chord/src/math.js
var abs2 = Math.abs;
var cos = Math.cos;
var sin = Math.sin;
var pi2 = Math.PI;
...
// ../graphs/node_modules/d3-chord/src/chord.js
function range2(i, j) {
...
function chord(directed, transpose2) {
  ...
  function chord2(matrix) {
    var n = matrix.length, groupSums = new Array(n), groupIndex = range2(0, n), chords = new Array(n * n), groups3 = new Array(n), k2 = 0, dx;
    ...
    dx = k2 ? padAngle : tau2 / n;
    {
      ...
      for (const i of groupIndex) {
        ...
        if (directed) {
          ...
          groups3[i] = { index: i, startAngle: x06, endAngle: x4, value: groupSums[i] };
        } else {
...
// ../graphs/node_modules/d3-path/src/path.js
var pi3 = Math.PI;
var tau3 = 2 * pi3;
var epsilon4 = 1e-6;
...
// ../graphs/node_modules/d3-chord/src/array.js
var slice2 = Array.prototype.slice;

// ../graphs/node_modules/d3-chord/src/constant.js
...
// ../graphs/node_modules/d3-chord/src/ribbon.js
...
// ../graphs/node_modules/d3-contour/src/array.js
var array3 = Array.prototype;
var slice3 = array3.slice;

// ../graphs/node_modules/d3-contour/src/ascending.js
function ascending_default(a4, b) {
  return a4 - b;
}

// ../graphs/node_modules/d3-contour/src/area.js
...
// ../graphs/node_modules/d3-contour/src/constant.js
var constant_default6 = (x4) => () => x4;

// ../graphs/node_modules/d3-contour/src/contains.js
...
// ../graphs/node_modules/d3-contour/src/noop.js
function noop_default() {
}

// ../graphs/node_modules/d3-contour/src/contours.js
var cases = [
  [],
  [[[1, 1.5], [0.5, 1]]],
  [[[1.5, 1], [1, 1.5]]],
...
// ../graphs/node_modules/d3-contour/src/density.js
function defaultX(d) {
  return d[0];
}
function defaultY(d) {
...
function density_default() {
  ...
  function density(data2) {
    var values = grid(data2), tz = threshold2(values), pow4k = Math.pow(2, 2 * k2);
    if (!Array.isArray(tz)) {
  ...
  density.contours = function(data2) {
    var values = grid(data2), contours = contours_default().size([n, m3]), pow4k = Math.pow(2, 2 * k2), contour = (value) => {
      value = +value;
...
// ../graphs/node_modules/robust-predicates/esm/util.js
...
// ../graphs/node_modules/robust-predicates/esm/orient2d.js
...
// ../graphs/node_modules/robust-predicates/esm/orient3d.js
...
// ../graphs/node_modules/robust-predicates/esm/incircle.js
...
// ../graphs/node_modules/robust-predicates/esm/insphere.js
...
// ../graphs/node_modules/delaunator/index.js
...
// ../graphs/node_modules/d3-delaunay/src/path.js
var epsilon6 = 1e-6;
var Path2 = class {
  constructor() {
    this._x0 = this._y0 = // start of current subpath
...
// ../graphs/node_modules/d3-delaunay/src/polygon.js
var Polygon = class {
  constructor() {
    this._ = [];
  }
...
// ../graphs/node_modules/d3-delaunay/src/voronoi.js
var Voronoi = class {
...
// ../graphs/node_modules/d3-delaunay/src/delaunay.js
var tau4 = 2 * Math.PI;
var pow = Math.pow;
function pointX(p) {
  return p[0];
...
// ../graphs/node_modules/d3-dsv/src/dsv.js
var EOL = {};
var EOF = {};
var QUOTE = 34;
var NEWLINE = 10;
...
// ../graphs/node_modules/d3-dsv/src/csv.js
var csv = dsv_default(",");
...
// ../graphs/node_modules/d3-dsv/src/tsv.js
var tsv = dsv_default("	");
...
// ../graphs/node_modules/d3-dsv/src/autoType.js
...
// ../graphs/node_modules/d3-fetch/src/blob.js
...
// ../graphs/node_modules/d3-fetch/src/buffer.js
...
// ../graphs/node_modules/d3-fetch/src/text.js
...
// ../graphs/node_modules/d3-fetch/src/dsv.js
...
// ../graphs/node_modules/d3-fetch/src/image.js
...
// ../graphs/node_modules/d3-fetch/src/json.js
...
// ../graphs/node_modules/d3-fetch/src/xml.js
...
// ../graphs/node_modules/d3-force/src/center.js
...
// ../graphs/node_modules/d3-quadtree/src/add.js
...
function addAll(data2) {
  var d, i, n = data2.length, x4, y4, xz = new Array(n), yz = new Array(n), x06 = Infinity, y06 = Infinity, x12 = -Infinity, y12 = -Infinity;
  for (i = 0; i < n; ++i) {
    if (isNaN(x4 = +this._x.call(null, d = data2[i])) || isNaN(y4 = +this._y.call(null, d)))
      continue;
    xz[i] = x4;
    yz[i] = y4;
    if (x4 < x06)
...
// ../graphs/node_modules/d3-quadtree/src/cover.js
...
// ../graphs/node_modules/d3-quadtree/src/data.js
...
// ../graphs/node_modules/d3-quadtree/src/extent.js
function extent_default(_) {
  return arguments.length ? this.cover(+_[0][0], +_[0][1]).cover(+_[1][0], +_[1][1]) : isNaN(this._x0) ? void 0 : [[this._x0, this._y0], [this._x1, this._y1]];
}

// ../graphs/node_modules/d3-quadtree/src/quad.js
...
// ../graphs/node_modules/d3-quadtree/src/find.js
function find_default(x4, y4, radius) {
  var data2, x06 = this._x0, y06 = this._y0, x12, y12, x22, y22, x32 = this._x1, y32 = this._y1, quads = [], node = this._root, q, i;
  if (node)
...
// ../graphs/node_modules/d3-quadtree/src/remove.js
...
// ../graphs/node_modules/d3-quadtree/src/root.js
function root_default() {
  return this._root;
}

// ../graphs/node_modules/d3-quadtree/src/size.js
...
// ../graphs/node_modules/d3-quadtree/src/visit.js
...
// ../graphs/node_modules/d3-quadtree/src/visitAfter.js
...
// ../graphs/node_modules/d3-quadtree/src/x.js
...
// ../graphs/node_modules/d3-quadtree/src/y.js
...
// ../graphs/node_modules/d3-quadtree/src/quadtree.js
...
// ../graphs/node_modules/d3-force/src/constant.js
...
// ../graphs/node_modules/d3-force/src/jiggle.js
function jiggle_default(random) {
  return (random() - 0.5) * 1e-6;
}

// ../graphs/node_modules/d3-force/src/collide.js
function x(d) {
  return d.x + d.vx;
}
function y(d) {
...
// ../graphs/node_modules/d3-force/src/link.js
function index2(d) {
  return d.index;
}
...
// ../graphs/node_modules/d3-force/src/lcg.js
var a = 1664525;
var c = 1013904223;
var m = 4294967296;
...
// ../graphs/node_modules/d3-force/src/simulation.js
function x2(d) {
  return d.x;
}
function y2(d) {
...
// ../graphs/node_modules/d3-force/src/manyBody.js
...
// ../graphs/node_modules/d3-force/src/radial.js
...
// ../graphs/node_modules/d3-force/src/x.js
...
// ../graphs/node_modules/d3-force/src/y.js
...
// ../graphs/node_modules/d3-format/src/precisionFixed.js
function precisionFixed_default(step) {
  return Math.max(0, -exponent_default(Math.abs(step)));
}

// ../graphs/node_modules/d3-format/src/precisionPrefix.js
function precisionPrefix_default(step, value) {
  return Math.max(0, Math.max(-8, Math.min(8, Math.floor(exponent_default(value) / 3))) * 3 - exponent_default(Math.abs(step)));
}

// ../graphs/node_modules/d3-format/src/precisionRound.js
function precisionRound_default(step, max5) {
  step = Math.abs(step), max5 = Math.abs(max5) - step;
  return Math.max(0, exponent_default(max5) - exponent_default(step)) + 1;
}

// ../graphs/node_modules/d3-geo/src/math.js
var epsilon7 = 1e-6;
var epsilon22 = 1e-12;
var pi4 = Math.PI;
var halfPi3 = pi4 / 2;
...
// ../graphs/node_modules/d3-geo/src/noop.js
function noop2() {
}

// ../graphs/node_modules/d3-geo/src/stream.js
...
// ../graphs/node_modules/d3-geo/src/area.js
...
// ../graphs/node_modules/d3-geo/src/cartesian.js
...
// ../graphs/node_modules/d3-geo/src/bounds.js
var lambda02;
var phi0;
var lambda1;
var phi1;
...
// ../graphs/node_modules/d3-geo/src/centroid.js
var W0;
var W1;
var X0;
var Y0;
...
// ../graphs/node_modules/d3-geo/src/constant.js
...
// ../graphs/node_modules/d3-geo/src/compose.js
...
// ../graphs/node_modules/d3-geo/src/rotation.js
...
// ../graphs/node_modules/d3-geo/src/circle.js
...
// ../graphs/node_modules/d3-geo/src/clip/buffer.js
...
// ../graphs/node_modules/d3-geo/src/pointEqual.js
function pointEqual_default(a4, b) {
  return abs3(a4[0] - b[0]) < epsilon7 && abs3(a4[1] - b[1]) < epsilon7;
}

// ../graphs/node_modules/d3-geo/src/clip/rejoin.js
...
// ../graphs/node_modules/d3-geo/src/polygonContains.js
...
// ../graphs/node_modules/d3-geo/src/clip/index.js
...
// ../graphs/node_modules/d3-geo/src/clip/antimeridian.js
...
// ../graphs/node_modules/d3-geo/src/clip/circle.js
...
// ../graphs/node_modules/d3-geo/src/clip/line.js
...
// ../graphs/node_modules/d3-geo/src/clip/rectangle.js
var clipMax = 1e9;
var clipMin = -clipMax;
...
// ../graphs/node_modules/d3-geo/src/clip/extent.js
...
// ../graphs/node_modules/d3-geo/src/length.js
var lengthSum;
var lambda03;
var sinPhi02;
var cosPhi02;
...
// ../graphs/node_modules/d3-geo/src/distance.js
...
// ../graphs/node_modules/d3-geo/src/contains.js
...
// ../graphs/node_modules/d3-geo/src/graticule.js
...
// ../graphs/node_modules/d3-geo/src/interpolate.js
...
// ../graphs/node_modules/d3-geo/src/identity.js
var identity_default3 = (x4) => x4;

// ../graphs/node_modules/d3-geo/src/path/area.js
...
// ../graphs/node_modules/d3-geo/src/path/bounds.js
var x03 = Infinity;
var y03 = x03;
var x1 = -x03;
var y1 = x1;
...
// ../graphs/node_modules/d3-geo/src/path/centroid.js
var X02 = 0;
var Y02 = 0;
var Z02 = 0;
var X12 = 0;
...
// ../graphs/node_modules/d3-geo/src/path/context.js
...
// ../graphs/node_modules/d3-geo/src/path/measure.js
...
// ../graphs/node_modules/d3-geo/src/path/string.js
var cacheDigits;
var cacheAppend;
var cacheRadius;
var cacheCircle;
...
// ../graphs/node_modules/d3-geo/src/path/index.js
...
// ../graphs/node_modules/d3-geo/src/transform.js
...
// ../graphs/node_modules/d3-geo/src/projection/fit.js
...
// ../graphs/node_modules/d3-geo/src/projection/resample.js
var maxDepth = 16;
...
// ../graphs/node_modules/d3-geo/src/projection/index.js
...
// ../graphs/node_modules/d3-geo/src/projection/conic.js
...
// ../graphs/node_modules/d3-geo/src/projection/cylindricalEqualArea.js
...
// ../graphs/node_modules/d3-geo/src/projection/conicEqualArea.js
...
// ../graphs/node_modules/d3-geo/src/projection/albers.js
function albers_default() {
  return conicEqualArea_default().parallels([29.5, 45.5]).scale(1070).translate([480, 250]).rotate([96, 0]).center([-0.6, 38.7]);
}

// ../graphs/node_modules/d3-geo/src/projection/albersUsa.js
...
// ../graphs/node_modules/d3-geo/src/projection/azimuthal.js
...
// ../graphs/node_modules/d3-geo/src/projection/azimuthalEqualArea.js
...
// ../graphs/node_modules/d3-geo/src/projection/azimuthalEquidistant.js
...
// ../graphs/node_modules/d3-geo/src/projection/mercator.js
...
// ../graphs/node_modules/d3-geo/src/projection/conicConformal.js
function tany(y4) {
...
// ../graphs/node_modules/d3-geo/src/projection/equirectangular.js
...
// ../graphs/node_modules/d3-geo/src/projection/conicEquidistant.js
...
// ../graphs/node_modules/d3-geo/src/projection/equalEarth.js
var A1 = 1.340264;
var A2 = -0.081106;
var A3 = 893e-6;
var A4 = 3796e-6;
...
// ../graphs/node_modules/d3-geo/src/projection/gnomonic.js
...
// ../graphs/node_modules/d3-geo/src/projection/identity.js
...
// ../graphs/node_modules/d3-geo/src/projection/naturalEarth1.js
...
// ../graphs/node_modules/d3-geo/src/projection/orthographic.js
...
// ../graphs/node_modules/d3-geo/src/projection/stereographic.js
...
// ../graphs/node_modules/d3-geo/src/projection/transverseMercator.js
...
// ../graphs/node_modules/d3-hierarchy/src/cluster.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/count.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/each.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/eachBefore.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/eachAfter.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/find.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/sum.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/sort.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/path.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/ancestors.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/descendants.js
function descendants_default() {
  return Array.from(this);
}

// ../graphs/node_modules/d3-hierarchy/src/hierarchy/leaves.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/links.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/iterator.js
...
// ../graphs/node_modules/d3-hierarchy/src/hierarchy/index.js
function hierarchy(data2, children2) {
  ...
  var root3 = new Node(data2), node, nodes = [root3], child, childs, i, n;
  while (node = nodes.pop()) {
...
// ../graphs/node_modules/d3-hierarchy/src/accessors.js
function optional(f) {
...
// ../graphs/node_modules/d3-hierarchy/src/constant.js
...
// ../graphs/node_modules/d3-hierarchy/src/lcg.js
var a2 = 1664525;
var c2 = 1013904223;
var m2 = 4294967296;
...
// ../graphs/node_modules/d3-hierarchy/src/array.js
...
// ../graphs/node_modules/d3-hierarchy/src/pack/enclose.js
...
// ../graphs/node_modules/d3-hierarchy/src/pack/siblings.js
...
// ../graphs/node_modules/d3-hierarchy/src/pack/index.js
...
// ../graphs/node_modules/d3-hierarchy/src/treemap/round.js
...
// ../graphs/node_modules/d3-hierarchy/src/treemap/dice.js
...
// ../graphs/node_modules/d3-hierarchy/src/partition.js
...
// ../graphs/node_modules/d3-hierarchy/src/stratify.js
var preroot = { depth: -1 };
var ambiguous = {};
var imputed = {};
...
function stratify_default() {
  ...
  function stratify(data2) {
    var nodes = Array.from(data2), currentId = id2, currentParentId = parentId, n, d, i, root3, parent, node, nodeId, nodeKey, nodeByKey = /* @__PURE__ */ new Map();
    if (path2 != null) {
...
// ../graphs/node_modules/d3-hierarchy/src/tree.js
...
// ../graphs/node_modules/d3-hierarchy/src/treemap/slice.js
...
// ../graphs/node_modules/d3-hierarchy/src/treemap/squarify.js
...
// ../graphs/node_modules/d3-hierarchy/src/treemap/index.js
...
// ../graphs/node_modules/d3-hierarchy/src/treemap/binary.js
...
// ../graphs/node_modules/d3-hierarchy/src/treemap/sliceDice.js
function sliceDice_default(parent, x06, y06, x12, y12) {
  (parent.depth & 1 ? slice_default : dice_default)(parent, x06, y06, x12, y12);
}

// ../graphs/node_modules/d3-hierarchy/src/treemap/resquarify.js
...
// ../graphs/node_modules/d3-polygon/src/area.js
...
// ../graphs/node_modules/d3-polygon/src/centroid.js
...
// ../graphs/node_modules/d3-polygon/src/cross.js
function cross_default(a4, b, c6) {
  return (b[0] - a4[0]) * (c6[1] - a4[1]) - (b[1] - a4[1]) * (c6[0] - a4[0]);
}

// ../graphs/node_modules/d3-polygon/src/hull.js
...
function computeUpperHullIndexes(points) {
  ...
  let size2 = 2, i;
  for (i = 2; i < n; ++i) {
    while (size2 > 1 && cross_default(points[indexes2[size2 - 2]], points[indexes2[size2 - 1]], points[i]) <= 0)
      --size2;
    indexes2[size2++] = i;
  }
...
// ../graphs/node_modules/d3-polygon/src/contains.js
...
// ../graphs/node_modules/d3-polygon/src/length.js
...
// ../graphs/node_modules/d3-random/src/defaultSource.js
var defaultSource_default = Math.random;

// ../graphs/node_modules/d3-random/src/uniform.js
...
// ../graphs/node_modules/d3-random/src/int.js
...
// ../graphs/node_modules/d3-random/src/normal.js
...
// ../graphs/node_modules/d3-random/src/logNormal.js
...
// ../graphs/node_modules/d3-random/src/irwinHall.js
...
// ../graphs/node_modules/d3-random/src/bates.js
...
// ../graphs/node_modules/d3-random/src/exponential.js
...
// ../graphs/node_modules/d3-random/src/pareto.js
...
// ../graphs/node_modules/d3-random/src/bernoulli.js
...
// ../graphs/node_modules/d3-random/src/geometric.js
...
// ../graphs/node_modules/d3-random/src/gamma.js
...
// ../graphs/node_modules/d3-random/src/beta.js
...
// ../graphs/node_modules/d3-random/src/binomial.js
...
// ../graphs/node_modules/d3-random/src/weibull.js
...
// ../graphs/node_modules/d3-random/src/cauchy.js
...
// ../graphs/node_modules/d3-random/src/logistic.js
...
// ../graphs/node_modules/d3-random/src/poisson.js
...
// ../graphs/node_modules/d3-random/src/lcg.js
var mul = 1664525;
var inc = 1013904223;
...
// ../graphs/node_modules/d3-scale/src/init.js
...
// ../graphs/node_modules/d3-scale/src/ordinal.js
...
// ../graphs/node_modules/d3-scale/src/band.js
function band() {
...
// ../graphs/node_modules/d3-scale/src/constant.js
...
// ../graphs/node_modules/d3-scale/src/number.js
function number3(x4) {
  return +x4;
}

// ../graphs/node_modules/d3-scale/src/continuous.js
var unit = [0, 1];
...
// ../graphs/node_modules/d3-scale/src/tickFormat.js
...
// ../graphs/node_modules/d3-scale/src/linear.js
...
// ../graphs/node_modules/d3-scale/src/identity.js
...
// ../graphs/node_modules/d3-scale/src/nice.js
...
// ../graphs/node_modules/d3-scale/src/log.js
...
// ../graphs/node_modules/d3-scale/src/symlog.js
...
// ../graphs/node_modules/d3-scale/src/pow.js
...
// ../graphs/node_modules/d3-scale/src/radial.js
function square(x4) {
...
// ../graphs/node_modules/d3-scale/src/quantile.js
function quantile2() {
...
// ../graphs/node_modules/d3-scale/src/quantize.js
function quantize() {
...
// ../graphs/node_modules/d3-scale/src/threshold.js
function threshold() {
...
// ../graphs/node_modules/d3-time/src/millisecond.js
...
// ../graphs/node_modules/d3-time/src/second.js
...
// ../graphs/node_modules/d3-time/src/minute.js
...
// ../graphs/node_modules/d3-time/src/hour.js
...
// ../graphs/node_modules/d3-time/src/month.js
...
// ../graphs/node_modules/d3-time/src/ticks.js
...
// ../graphs/node_modules/d3-time-format/src/isoFormat.js
...
// ../graphs/node_modules/d3-time-format/src/isoParse.js
...
// ../graphs/node_modules/d3-scale/src/time.js
function date(t) {
  return new Date(t);
}
function number4(t) {
...
// ../graphs/node_modules/d3-scale/src/utcTime.js
function utcTime() {
  return initRange.apply(calendar(utcTicks, utcTickInterval, utcYear, utcMonth, utcSunday, utcDay, utcHour, utcMinute, second, utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}

// ../graphs/node_modules/d3-scale/src/sequential.js
...
// ../graphs/node_modules/d3-scale/src/sequentialQuantile.js
...
// ../graphs/node_modules/d3-scale/src/diverging.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/colors.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/categorical/category10.js
var category10_default = colors_default("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Accent.js
var Accent_default = colors_default("7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Dark2.js
var Dark2_default = colors_default("1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Paired.js
var Paired_default = colors_default("a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Pastel1.js
var Pastel1_default = colors_default("fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Pastel2.js
var Pastel2_default = colors_default("b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Set1.js
var Set1_default = colors_default("e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Set2.js
var Set2_default = colors_default("66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Set3.js
var Set3_default = colors_default("8dd3c7ffffb3bebadafb807280b1d3fdb462b3de69fccde5d9d9d9bc80bdccebc5ffed6f");

// ../graphs/node_modules/d3-scale-chromatic/src/categorical/Tableau10.js
var Tableau10_default = colors_default("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab");

// ../graphs/node_modules/d3-scale-chromatic/src/ramp.js
var ramp_default = (scheme28) => rgbBasis(scheme28[scheme28.length - 1]);

// ../graphs/node_modules/d3-scale-chromatic/src/diverging/BrBG.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/PRGn.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/PiYG.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/PuOr.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/RdBu.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/RdGy.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/RdYlBu.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/RdYlGn.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/diverging/Spectral.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/BuGn.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/BuPu.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/GnBu.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/OrRd.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/PuBuGn.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/PuBu.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/PuRd.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/RdPu.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/YlGnBu.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/YlGn.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/YlOrBr.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/YlOrRd.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-single/Blues.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-single/Greens.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-single/Greys.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-single/Purples.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-single/Reds.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-single/Oranges.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/cividis.js
function cividis_default(t) {
  t = Math.max(0, Math.min(1, t));
  return "rgb(" + Math.max(0, Math.min(255, Math.round(-4.54 - t * (35.34 - t * (2381.73 - t * (6402.7 - t * (7024.72 - t * 2710.57))))))) + ", " + Math.max(0, Math.min(255, Math.round(32.49 + t * (170.73 + t * (52.82 - t * (131.46 - t * (176.58 - t * 67.37))))))) + ", " + Math.max(0, Math.min(255, Math.round(81.24 + t * (442.36 - t * (2482.43 - t * (6167.24 - t * (6614.94 - t * 2475.67))))))) + ")";
}

// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/cubehelix.js
var cubehelix_default2 = cubehelixLong(cubehelix(300, 0.5, 0), cubehelix(-240, 0.5, 1));

// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/rainbow.js
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/sinebow.js
var c4 = rgb();
...
// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/turbo.js
function turbo_default(t) {
  t = Math.max(0, Math.min(1, t));
  return "rgb(" + Math.max(0, Math.min(255, Math.round(34.61 + t * (1172.33 - t * (10793.56 - t * (33300.12 - t * (38394.49 - t * 14825.05))))))) + ", " + Math.max(0, Math.min(255, Math.round(23.31 + t * (557.33 + t * (1225.33 - t * (3574.96 - t * (1073.77 + t * 707.56))))))) + ", " + Math.max(0, Math.min(255, Math.round(27.2 + t * (3211.1 - t * (15327.97 - t * (27814 - t * (22569.18 - t * 6838.66))))))) + ")";
}

// ../graphs/node_modules/d3-scale-chromatic/src/sequential-multi/viridis.js
...
// ../graphs/node_modules/d3-shape/src/constant.js
...
// ../graphs/node_modules/d3-shape/src/math.js
var abs4 = Math.abs;
...
// ../graphs/node_modules/d3-shape/src/path.js
...
// ../graphs/node_modules/d3-shape/src/arc.js
...
// ../graphs/node_modules/d3-shape/src/array.js
var slice4 = Array.prototype.slice;
function array_default3(x4) {
  return typeof x4 === "object" && "length" in x4 ? x4 : Array.from(x4);
}

// ../graphs/node_modules/d3-shape/src/curve/linear.js
...
// ../graphs/node_modules/d3-shape/src/point.js
function x3(p) {
  return p[0];
}
function y3(p) {
...
// ../graphs/node_modules/d3-shape/src/line.js
function line_default2(x4, y4) {
  ...
  function line(data2) {
    ...
    for (i = 0; i <= n; ++i) {
      ...
      if (defined0)
        output.point(+x4(d, i, data2), +y4(d, i, data2));
    }
    if (buffer)
...
// ../graphs/node_modules/d3-shape/src/area.js
function area_default5(x06, y06, y12) {
  ...
  function area(data2) {
    var i, j, k2, n = (data2 = array_default3(data2)).length, d, defined0 = false, buffer, x0z = new Array(n), y0z = new Array(n);
    if (context == null)
      output = curve(buffer = path2());
    for (i = 0; i <= n; ++i) {
      if (!(i < n && defined(d = data2[i], i, data2)) === defined0) {
...
// ../graphs/node_modules/d3-shape/src/descending.js
function descending_default(a4, b) {
  return b < a4 ? -1 : b > a4 ? 1 : b >= a4 ? 0 : NaN;
}

// ../graphs/node_modules/d3-shape/src/identity.js
function identity_default5(d) {
  return d;
}

// ../graphs/node_modules/d3-shape/src/pie.js
function pie_default() {
  ...
  function pie(data2) {
    var i, n = (data2 = array_default3(data2)).length, j, k2, sum4 = 0, index3 = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da2 = Math.min(tau6, Math.max(-tau6, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da2) / n, padAngle.apply(this, arguments)), pa = p * (da2 < 0 ? -1 : 1), v2;
    for (i = 0; i < n; ++i) {
      if ((v2 = arcs[index3[i] = i] = +value(data2[i], i, data2)) > 0) {
        sum4 += v2;
      }
    }
    if (sortValues != null)
...
// ../graphs/node_modules/d3-shape/src/curve/radial.js
...
// ../graphs/node_modules/d3-shape/src/lineRadial.js
...
// ../graphs/node_modules/d3-shape/src/areaRadial.js
...
// ../graphs/node_modules/d3-shape/src/pointRadial.js
function pointRadial_default(x4, y4) {
  return [(y4 = +y4) * Math.cos(x4 -= Math.PI / 2), y4 * Math.sin(x4)];
}

// ../graphs/node_modules/d3-shape/src/curve/bump.js
var Bump = class {
...
// ../graphs/node_modules/d3-shape/src/link.js
...
// ../graphs/node_modules/d3-shape/src/symbol/asterisk.js
var sqrt32 = sqrt3(3);
...
// ../graphs/node_modules/d3-shape/src/symbol/circle.js
var circle_default3 = {
  draw(context, size2) {
...
// ../graphs/node_modules/d3-shape/src/symbol/cross.js
var cross_default2 = {
  draw(context, size2) {
...
// ../graphs/node_modules/d3-shape/src/symbol/diamond.js
var tan30 = sqrt3(1 / 3);
var tan30_2 = tan30 * 2;
var diamond_default = {
  draw(context, size2) {
    const y4 = sqrt3(size2 / tan30_2);
    const x4 = y4 * tan30;
    context.moveTo(0, -y4);
    context.lineTo(x4, 0);
    context.lineTo(0, y4);
...
// ../graphs/node_modules/d3-shape/src/symbol/diamond2.js
...
// ../graphs/node_modules/d3-shape/src/symbol/plus.js
var plus_default = {
  draw(context, size2) {
...
// ../graphs/node_modules/d3-shape/src/symbol/square.js
var square_default = {
  draw(context, size2) {
    const w = sqrt3(size2);
    const x4 = -w / 2;
...
// ../graphs/node_modules/d3-shape/src/symbol/square2.js
var square2_default = {
  draw(context, size2) {
...
// ../graphs/node_modules/d3-shape/src/symbol/star.js
...
// ../graphs/node_modules/d3-shape/src/symbol/triangle.js
var sqrt33 = sqrt3(3);
var triangle_default = {
  draw(context, size2) {
    const y4 = -sqrt3(size2 / (sqrt33 * 3));
...
// ../graphs/node_modules/d3-shape/src/symbol/triangle2.js
var sqrt34 = sqrt3(3);
...
// ../graphs/node_modules/d3-shape/src/symbol/wye.js
var c5 = -0.5;
var s = sqrt3(3) / 2;
var k = 1 / sqrt3(12);
var a3 = (k / 2 + 1) * 3;
...
// ../graphs/node_modules/d3-shape/src/symbol/times.js
var times_default = {
  draw(context, size2) {
...
// ../graphs/node_modules/d3-shape/src/symbol.js
var symbolsFill = [
  circle_default3,
  cross_default2,
  diamond_default,
...
function Symbol2(type2, size2) {
  ...
  symbol.size = function(_) {
    return arguments.length ? (size2 = typeof _ === "function" ? _ : constant_default10(+_), symbol) : size2;
  };
...
// ../graphs/node_modules/d3-shape/src/noop.js
function noop_default2() {
}

// ../graphs/node_modules/d3-shape/src/curve/basis.js
...
// ../graphs/node_modules/d3-shape/src/curve/basisClosed.js
...
// ../graphs/node_modules/d3-shape/src/curve/basisOpen.js
...
// ../graphs/node_modules/d3-shape/src/curve/bundle.js
...
// ../graphs/node_modules/d3-shape/src/curve/cardinal.js
...
// ../graphs/node_modules/d3-shape/src/curve/cardinalClosed.js
...
// ../graphs/node_modules/d3-shape/src/curve/cardinalOpen.js
...
// ../graphs/node_modules/d3-shape/src/curve/catmullRom.js
...
// ../graphs/node_modules/d3-shape/src/curve/catmullRomClosed.js
...
// ../graphs/node_modules/d3-shape/src/curve/catmullRomOpen.js
...
// ../graphs/node_modules/d3-shape/src/curve/linearClosed.js
...
// ../graphs/node_modules/d3-shape/src/curve/monotone.js
function sign2(x4) {
  return x4 < 0 ? -1 : 1;
}
...
// ../graphs/node_modules/d3-shape/src/curve/natural.js
...
// ../graphs/node_modules/d3-shape/src/curve/step.js
...
// ../graphs/node_modules/d3-shape/src/offset/none.js
...
// ../graphs/node_modules/d3-shape/src/order/none.js
...
// ../graphs/node_modules/d3-shape/src/stack.js
...
// ../graphs/node_modules/d3-shape/src/offset/expand.js
...
// ../graphs/node_modules/d3-shape/src/offset/diverging.js
...
// ../graphs/node_modules/d3-shape/src/offset/silhouette.js
...
// ../graphs/node_modules/d3-shape/src/offset/wiggle.js
...
// ../graphs/node_modules/d3-shape/src/order/appearance.js
...
// ../graphs/node_modules/d3-shape/src/order/ascending.js
...
// ../graphs/node_modules/d3-shape/src/order/descending.js
function descending_default2(series) {
  return ascending_default2(series).reverse();
}

// ../graphs/node_modules/d3-shape/src/order/insideOut.js
...
// ../graphs/node_modules/d3-shape/src/order/reverse.js
function reverse_default(series) {
  return none_default2(series).reverse();
}

// ../graphs/node_modules/d3-zoom/src/constant.js
var constant_default11 = (x4) => () => x4;

// ../graphs/node_modules/d3-zoom/src/event.js
...
// ../graphs/node_modules/d3-zoom/src/noevent.js
...
// ../graphs/node_modules/d3-zoom/src/zoom.js
...
var GroupControllerV1 = class {
  constructor(frame3, config2, index3) {
    this.frame = frame3;
    this.config = config2;
    this.index = index3;
...
var parseDuration = (duration) => {
  ...
  let m3 = Math.floor(d % 3600 / 60);
  let s2 = Math.floor(d % 3600 % 60);
  var hDisplay = h > 0 ? h + ":" : "";
  var mDisplay = m3 > 0 ? twoDigit(m3) + ":" : "";
  var sDisplay = s2 > 0 ? twoDigit(s2) : "";
  return hDisplay + mDisplay + sDisplay;
};
var calcSpeed = (s2) => {
  const kmh = Number(s2) * 3.6;
  const pacePerKm = 60 / kmh;
  const minutes = Math.floor(pacePerKm);
  const seconds2 = Math.round((pacePerKm - minutes) * 60);
  const formattedPace = `${minutes}:${seconds2 < 10 ? "0" : ""}${seconds2}`;
...
var TypeIcon = class {
  ...
  draw(activity) {
    ...
    this.element.style.gridColumn = "5 / span 4";
    this.element.style.gridRow = "2 / span 6";
...
var RunGroupV1 = class extends GroupControllerV1 {
  constructor(page, data2, config2, index3) {
    super(page, config2, index3);
    this.page = page;
    this.data = data2;
    this.config = config2;
    this.index = index3;
...
var ScaleService = class {
  ...
  set(data2, minValue) {
    ...
    let min4 = window.d3.min(data2.filter((v2) => !isNaN(v2)));
    let max5 = window.d3.max(data2.filter((v2) => !isNaN(v2)));
    switch (this.config.type) {
      case "linear":
        if (min4 == void 0 || max5 == void 0)
          return;
        this.scale = window.d3.scaleLinear().domain([parseFloat(min4), parseFloat(max5)]);
        break;
      case "log":
        if (min4 == void 0 || max5 == void 0)
          return;
        this.scale = window.d3.scaleLog().domain([1, parseFloat(max5)]);
        break;
      case "log1000":
        if (min4 == void 0 || max5 == void 0)
          return;
        this.scale = window.d3.scaleLog().domain([1e5, parseFloat(max5)]);
        break;
      case "radius":
        if (min4 == void 0 || max5 == void 0)
          return;
        this.scale = window.d3.scalePow().domain([parseFloat(min4), parseFloat(max5)]).nice();
        break;
      case "time":
        min4 = window.d3.min(data2.map((v2) => new Date(v2)));
        max5 = window.d3.max(data2.map((v2) => new Date(v2)));
        this.scale = window.d3.scaleTime().domain([new Date(min4), new Date(max5)]);
        break;
      case "band":
...
function convertToCurrency(number5) {
  number5 = Math.ceil(number5);
  return number5.toLocaleString("nl-NL", { style: "currency", currency: "EUR", minimumFractionDigits: 0 });
}
...
var AxesService = class {
  ...
  redraw(dimensions, scale2, data2) {
    switch (this.ctrlr.scales[this.config.scale].config.type) {
      ...
      case "time":
        ...
        this.axis.ticks(window.d3[tickOrder].every(tickSpread)).tickFormat((date2) => window.d3.timeYear(date2) < date2 ? localTime.format("%b")(date2) : localTime.format("%Y")(date2));
        break;
      case "bandTime":
        this.axis.ticks(window.d3[this.ctrlr.config.extra.xScaleTicks].every(1)).tickFormat((date2) => localTime.format("%d %b")(new Date(date2)));
        break;
      case "stacked":
        this.axis.ticks(10, "%");
        break;
    ...
    this.axisGroup.transition().duration(1e3).call(this.axis.scale(scale2));
...
var SvgService = class {
  constructor(element, config2, dimensions, svg2) {
...
var GraphControllerV3 = class {
  constructor(slug, frame3, group2, mapping) {
    this.slug = slug;
    this.frame = frame3;
    this.group = group2;
  ...
  async _svg(svgWrapper) {
    ...
    for (let c6 of this.config.scales) {
      this.scales[c6.slug] = new ScaleService(this, c6);
    }
    for (let c6 of this.config.axes) {
      this.axes[c6.slug] = new AxesService(this, c6);
    }
    return;
  }
  async redraw(data2, range4) {
    ...
    if (this.config.scales) {
      for (let c6 of this.config.scales) {
        this.scales[c6.slug].reset();
      }
    }
    for (let a4 of this.config.axes) {
      this.axes[a4.slug].redraw(this.dimensions, this.scales[a4.scale].scale, data2.slice);
    }
    return;
  }
  async draw(data2) {
  ...
  async _update(newData, segment, update, range4) {
    let self = this;
    const data2 = self.prepareData(newData);
    this.preparedData = Object.assign({}, data2);
    await self.draw(this.preparedData);
    await self.redraw(this.preparedData, range4);
  ...
  _addAxis(slug, scale2, position, format2, extra, label2) {
  ...
  _addMargin(top2, bottom2, left2, right2) {
    this.config.margin = {
      top: top2,
      bottom: bottom2,
      left: left2,
  ...
  _addPadding(top2, bottom2, left2, right2) {
    this.config.padding = {
      top: top2,
      bottom: bottom2,
      left: left2,
...
// runv1/elements/chart-bars-band-rounded.ts
var ChartBarsBandRounded = class {
  constructor(ctrlr) {
    this.ctrlr = ctrlr;
  }
  bars;
  ...
  barValues;
  draw(data2) {
    this.bars = this.ctrlr.svg.layers.data.selectAll(".bar").data(data2).join("rect").attr("class", "bar").attr("fill", (d, i) => d.selected ? "#f4c6e2" : "white").attr("stroke", (d, i) => "white");
    this.barDates = this.ctrlr.svg.layers.data.selectAll(".barLabel").data(data2).join("text").attr("class", "barLabel").style("text-anchor", "middle").style("fill", "#472A91").style("font-size", "4.2rem").style("font-family", "'Inkwell Condensed A', 'Inkwell Condensed B'").style("font-weight", "700");
    this.barValues = this.ctrlr.svg.layers.data.selectAll(".barValues").data(data2).join("text").attr("class", "barValues").style("text-anchor", "middle").style("fill", "#fff").style("font-size", "4.2rem").style("font-family", "'Inkwell Condensed A', 'Inkwell Condensed B'").style("font-weight", "700");
  }
  redraw(data2) {
    let self = this;
    this.bars.attr("y", (d, i) => this.ctrlr.dimensions.height - self.ctrlr.scales.y.fn(d.yValue)).attr("height", (d) => self.ctrlr.scales.y.fn(d.yValue)).attr("x", (d) => self.ctrlr.scales.x.fn(d.xValue)).attr("width", (d, i) => self.ctrlr.scales.x.scale.bandwidth());
    this.barDates.html((d, i) => {
      console.log(new Date(d.xValue));
      const day = new Date(d.xValue).getDate();
      const month = (new Date(d.xValue).getMonth() + 1).toString();
      return day + "/" + month;
    }).attr("transform", (d, i) => {
      const x4 = self.ctrlr.scales.x.fn(d.xValue) + self.ctrlr.scales.x.scale.bandwidth() / 2;
      const y4 = this.ctrlr.dimensions.height - 30;
      return "translate(" + x4 + "," + y4 + ")";
    });
    this.barValues.html((d, i) => {
      return parseDuration(d.yValue);
    }).attr("transform", (d, i) => {
      const x4 = self.ctrlr.scales.x.fn(d.xValue) + self.ctrlr.scales.x.scale.bandwidth() / 2;
      const y4 = self.ctrlr.dimensions.height - self.ctrlr.scales.y.fn(d.yValue) - 30;
      return "translate(" + x4 + "," + y4 + ")";
    });
  }
};

// runv1/graphs/my-runs-v1.ts
var MyRunsV1 = class extends GraphControllerV3 {
  constructor(slug, frame3, group2, mapping, segment, index3) {
    super(slug, frame3, group2, mapping);
    this.slug = slug;
    this.frame = frame3;
    this.group = group2;
    this.mapping = mapping;
  ...
  prepareData(data2) {
    data2.bars = [];
    for (let a4 of data2.comparison) {
      data2.bars.push(
        {
          label: a4.title,
          xValue: a4.local_time,
          yValue: a4[this.mapping[0][0].column],
          colour: "white",
          selected: a4.local_time == data2.activity.local_time ? true : false
        }
      );
    }
  ...
  async draw(data2) {
    this.scales.x.set(data2.bars.map((d) => d.xValue));
    this.scales.y.set(data2.bars.map((d) => d.yValue).concat([0]));
    this.bars.draw(data2.bars);
  }
  async redraw(data2, range4) {
    await super.redraw(data2);
    this.bars.redraw(this.dimensions);
  }
  async update(data2, segment, update, range4) {
    await super._update(data2, segment, update, range4);
  }
};
...
var FrameCtrlr = class {
  ...
  async init(config2, groups3, graphs2, htmlContainer, data2) {
    for (let mapping of config2) {
      let j = 0;
      const group2 = {
        slug: mapping.slug,
        splice: mapping.splice,
        ctrlr: new groups3[mapping.ctrlr](this, data2, mapping, j),
        graphs: [],
        config: mapping,
        element: null,
        data: {}
      };
      group2.element = group2.ctrlr.html(htmlContainer);
      let i = 0;
      for (const graph of mapping.graphs) {
        group2.graphs.push({
          ...
          ctrlr: new graphs2[this, graph.ctrlr](graph.slug, this, group2, graph.parameters, i)
        });
        i++;
      }
      j++;
      this.frameConfig.push(group2);
    }
  ...
  prepareData(data2) {
    for (const group2 of this.frameConfig) {
      group2.data = group2.ctrlr.prepareData(data2);
    }
  }
  initGroups(htmlContainer) {
    for (const group2 of this.frameConfig) {
      if (group2.ctrlr == null)
        return;
      group2.ctrlr.init(htmlContainer);
    }
  }
  initGraphs() {
    for (const group2 of this.frameConfig) {
      for (const graph of group2.graphs) {
        if (graph.ctrlr == null)
          return;
        graph.ctrlr.html();
        graph.ctrlr.init();
